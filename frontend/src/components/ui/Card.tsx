...
const Card: React.FC<CardProps> = ({ title, description, xp, faded = false, isCTA = false }) => {
  // If the description is really long, we add scroll behavior.
  const shouldScroll = description.length > 100; // Adjust threshold as needed
